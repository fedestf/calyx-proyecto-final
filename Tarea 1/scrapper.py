...
for elem in titular:
    ...
    with open(r'Tarea 1\Noticias salida\principales.txt', "a") as file:
...
for elem in titular:
    ...
    if sub[0].get('href').startswith('/politica'):  # SI HREF EMPIEZA CON /economia
        ...
        with open(r'Tarea 1\Noticias salida\politicas.txt', "a") as file:
...
for elem in titular:
    ...
    if sub[0].get('href').startswith('/economia'):  # SI HREF EMPIEZA CON /economia
        ...
        with open(r'Tarea 1\Noticias salida\economicas.txt', "a") as file:
